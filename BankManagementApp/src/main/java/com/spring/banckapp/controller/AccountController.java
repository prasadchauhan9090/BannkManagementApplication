package com.spring.banckapp.controller;
...
import com.spring.banckapp.service.AccountService;
...
public class AccountController {
	...
	//create the account
	@PostMapping("/create")
	public ResponseEntity<Account> createAccount(@RequestBody Account acount)
	{
		Account createAccount=service.createAccount(acount);
	...
	public ResponseEntity<String> deleteAccount(@PathVariable Long accountNumber)
	{
		...
		return ResponseEntity.status(HttpStatus.ACCEPTED).body("YOUR ACCOUNT CLOSED SUCCESSFULLY");
	}
